...
sidebar_position: 2
id: ssjs-create-de
title: 應用 SSJS 在 Automation Studio 建立 Data Extension
tags:
  - Salesforce
  - Data extension
  - SSJS
...
# 應用 SSJS 在 Automation Studio 建立 Data Extension

## 前提

在執行專案的過程中，遇到需要創建大量的 Data Extension，因此想要透過程式的手段快速批次建立 Data Extension。
...
因為專案需求，起初花了一些時間查找官方文件中關於 SSJS 的資料，覺得網頁上的說明不是十分清楚，文件上的範例程式碼也沒辦法成功被執行。於是額外查找了一些其他網站上的資料，才得以成功執行程式碼。原本自己的開發習慣是以官方文件為主，但這次的實作讓我覺得有時候也可以試著多方查找第三方資料，參考別人的實作經驗，才能更快速地解決問題。
